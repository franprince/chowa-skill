# Optional plugin distribution — implementation record
...
Claude Code plugin packaging remains available. The standalone skill is the portable distribution unit for Claude Code, Codex, and Gemini CLI; runtime resources travel with the skill directory.
