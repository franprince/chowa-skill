# Project opt-in detection — implementation record
...
Recognize specs/INDEX.md, chowa.config.js/.ts/.mjs, personal alwaysOn, or explicit user requests. Stateless hooks use persistent signals. Unrelated repositories keep their own conventions.
