...
Delegate bounded work with known outputs only when worthwhile and permitted. Use available native subagents or execute inline. The primary agent reviews changes and verifies results.
