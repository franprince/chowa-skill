...
PR descriptions explain resulting behavior and verification. Release and hotfix descriptions include rollout or rollback details where relevant. The agent writes them using git and gh.
