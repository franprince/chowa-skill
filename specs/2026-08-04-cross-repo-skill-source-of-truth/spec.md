...
One local template generates the skill and its on-demand references. The generator validates all outputs and packages runtime resources inside the skill directory.
